...
public class One_copy 
{
    ...
    throws IOException 
    {
        BufferedReader in = new BufferedReader(new FileReader("C:\\VSCode\\Java\\Project2\\src\\a2.txt"));
        ...
        for(int j=0;j<30;j++){                      //ввод чисел в массив x
            x[j] = Integer.parseInt(strScores[j]);
        }

        for(int j=30,i=0;i<30;j++,i++){             //ввод чисел в массив y
